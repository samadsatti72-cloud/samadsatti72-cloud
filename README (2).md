...
```python
class AbdulSamadSatti:
    def __init__(self):
        self.name = "Abdul Samad Satti"
        self.role = "BS Artificial Intelligence Student"
        self.location = "Islamabad, Pakistan"
        self.languages = ["Python", "TypeScript", "JavaScript"]
        self.focus = ["Machine Learning", "AI Applications", "Automation"]
        self.currently_building = "Real-world AI systems that solve real problems"
...
- 🎓 AI student turning coursework into shipped products
- 🛠️ I build end-to-end — data, models, backend, and the UI on top
- 🇵🇰 Passionate about AI solutions built *for* Pakistan's real problems (justice, business, accessibility)
- ⚡ Currently exploring Monte Carlo simulation, NLP, and speech AI
- 📫 Reach me by opening an issue on any of my repos, or add your contact links below
